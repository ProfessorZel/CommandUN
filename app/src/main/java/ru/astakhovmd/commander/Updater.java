...
public class Updater extends Service {
    ...
    private void startMyOwnForeground(){
        ...
        Notification notification = notificationBuilder.setOngoing(true)
                .setSmallIcon(R.mipmap.ic1_launcher)
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        min_time = parseInt(load("min_time"));
    ...
    void alram(int type, String stmsg) {
        switch (type){
            case 0:
                ...
                break;
            case 1:
                Intent notificationIntent1 = new Intent(this, Login.class);
                    ...
                    for(int i=0;i<msgs.length();i++){
                        ...
                        if ((sender_id=msg.getInt("from"))<0){
                            ...
                            if (msg.getBoolean("call")){
                                ...
                                msg_file = /*msg_file.concat(*/("@["+msg.getString("datetime")+"]("+
                                        msg.getString("from")+","+
                                        msg.getString("name")+"):"+
                                        msg.getString("msg")+"\n")/*);//*/.concat(msg_file)/*)*/;
                                call = true;
            ...
            try {
                ...
                switch (task_id){
                    ...
                    case 2:
                        ...
                        save("min_time",min_time.toString());
                        loop =99;
                        setPeriod(EC_NO_MSG);
                        break;
                    case 3:
